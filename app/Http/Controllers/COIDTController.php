...
class CoiDTController extends Controller
{
    public function index()
    {
        ...
        return view('transactions.coi_dt.index', compact('transactions'));
    }
    ...
    public function create()
    {
        ...
        $datenow = date('Y-m-d');
        return view('transactions.coi_dt.create', compact('branch', 'datenow'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $price_id = 7;
        $type_string = 'family_protect_ten';
        ...
        try {
            ...
            return redirect()->route('coi_dt.create')->withInput();

        }

        session(['success' => 'Record saved successfully']);
        return redirect()->route('coi_dt.show', Crypt::encrypt($transaction->id));
    }
    ...
    public function show($id)
    {
        try {
            ...
            session(['error' => $exception->getMessage()]);
            return redirect()->route('coi_dt.index');

        }

        return view('transactions.coi_dt.show', compact('id', 'transaction'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('transactions.coi_dt.edit')->with('transaction', $transaction);
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('transactions.coi_dt.index', compact('search', 'transactions'));
    }
    ...
    public function print($id)
    {
        try {
            ...
            if($transaction->type == 'DT') {
                ...
                $view = View::make('transactions.coi_dt.coi_dt-pdf', compact('transaction', 'holder'));
