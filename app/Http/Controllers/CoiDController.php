...
class CoiDController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $transaction->price = Insuran_price::find(2)->price;
            $transaction->terminal_coi_number = CommonController::getCoiNumber();
            $transaction->policy_number = Setting::where('name', 'family_protect')->first()->value;
        ...
        return redirect()->route('coi_d.show', $transaction->id);
    }
    ...
    {
        $transaction = Transaction::find($id);
        return view('transactions.coi_d.edit')
    ...
    public function print($id)
    {
        ...
        if($transaction->type == 'D') {
            ...
            // for ($i=0; $i < $transaction->units; $i++) { 
            //     $holder1 = $holder1 + 30000;
            //     $holder['unprovoke_principal'] =  number_format(($holder1 > 60000 ? 60000 : $holder1),2);
            //     $holder['motor_principal'] =  number_format(($holder1 > 30000 ? 30000 : $holder1),2);
            // }$holder1 = 0;
            ...
            //     $holder['burial_principal'] =  number_format($holder1 > 10000 ? 10000 : $holder1,2);
            // }
            // $holder1 = 0;
