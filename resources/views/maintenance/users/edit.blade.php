...
@section('header')
    <div class="row align-items-center py-4">
        ...
        <div class="col-5 col-lg-6 text-right">
            ...
            <a href="{{ route('users.show', $user->id) }}" class="btn btn-sm btn-neutral loading">Show</a>
            ...
            <div class="container">
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="username" name="username" class="form-control @error('username') is-invalid @enderror" placeholder="User Name" value="{{ $user->username }}" />
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" id="full_name" name="full_name" class="form-control @error('full_name') is-invalid @enderror" placeholder="Full Name" value="{{ $user->full_name }}" />
