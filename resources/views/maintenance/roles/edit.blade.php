...
@section('header')
    <div class="row align-items-center py-4">
        ...
        <div class="col-5 col-lg-6 text-right">
            ...
            <a href="{{ route('roles.show', $role->id) }}" class="btn btn-sm btn-neutral loading">Show</a>
            ...
            <div class="container">
                <div class="row">
                    <div class="form-group col-12 col-md-6">
                        ...
                        <input type="text" id="role_name" name="role_name" class="form-control @error('role_name') is-invalid @enderror" placeholder="Role Name" value="{{ $role->role_name }}" />
