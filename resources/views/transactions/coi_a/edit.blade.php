...
@section('header')
    <div class="row align-items-center py-4">
        ...
        <div class="col-5 col-lg-6 text-right">
            ...
            <a href="{{ route('coi_a.show', Crypt::encrypt($transaction->id)) }}" class="btn btn-sm btn-neutral loading">Show</a>
...
<div class="card">
    ...
    <div class="card-header border-0">
        <form  method="POST" action="{{ route('coi_a.update', ['id' => Crypt::encrypt($transaction->id)]) }}">
            @method('patch')
            @csrf
            <div class="container">
                <div class="row">
