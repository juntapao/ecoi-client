...
@section('delete', route('coi_c.destroy', Crypt::encrypt($transaction->id)))
@section('header')
    <div class="row align-items-center py-4">
        <div class="col-7 col-lg-6">
            ...
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                ...
                <li class="breadcrumb-item"><a href="{{ route('coi_c.index') }}">Customer Protect 20</a></li>
        ...
        <div class="col-5 col-lg-6 text-right">
            ...
            @if($transaction->posted == null)
                <a href="{{ route('coi_c.edit', Crypt::encrypt($transaction->id)) }}" class="btn btn-sm btn-neutral loading">Edit</a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" value="{{ strtoupper($transaction->relationship) }}" readonly />
                </div>
            </div>
        </div>
        <div class="text-right">
            @if($transaction->posted == null)
                <a href="{{ route('coi_c.post', Crypt::encrypt($transaction->id)) }}" class="btn btn-success" onclick="return confirm('Are you sure you want to Post this transaction?')">Post</a>
            @else
                <a href="{{ route('coi_c.print', Crypt::encrypt($transaction->id)) }}" class="btn btn-success">Print</a>
            @endif
        </div>
    </div>
</div>
