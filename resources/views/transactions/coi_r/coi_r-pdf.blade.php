    ...
    <table class="tb1" >
        ...
        <tr class="font10">
            <td width = "100%" align="center" style="font-size:13px">
                <strong>Confirmation of Insurance - PAWNER'S PROTECT</strong>
            </td>
        </tr>
        <tr><td></td></tr>
        <tr class="font10">
            ...
            <td width = "10%">:</td>
            <td width = "50%">R<strong>{{ $transaction->terminal_coi_number }}</strong></td>
        </tr>
        <tr class="font10">
            <td width = "5%"></td>
        ...
        <tr class="font10">
            ...
            <td width = "10%">:</td>
            {{-- <td width = "55%">1.{{$transaction->child_siblings}} {{ $transaction->child_siblings_dateofbirth ? Carbon\Carbon::parse($transaction->child_siblings_dateofbirth)->format('m/d/Y') : null }}</td> --}}
        ...
        <tr class="font10">
            ...
            <td width = "10%">:</td>
            <td width = "50%"><strong>ML PAWNER'S PROTECT PROGRAM</strong></td>
        </tr>
        <tr class="font10">
            <td width = "5%"></td>
        ...
        <tr class="font10"> 
            ...
            <td width = "10%">:</td>
            <td width = "55%">{{ $transaction->date_issued->format('F d, Y') }} to {{ $transaction->date_issued->addMonth(4)->format('F d, Y') }}</td>
        </tr>    
        <tr class="font10">
            <td width = "5%"></td>
