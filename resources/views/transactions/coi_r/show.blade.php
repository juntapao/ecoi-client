    ...
    <div class="row align-items-center py-4">
        ...
        <div class="col-5 col-lg-6 text-right">
            ...
            @if(!$transaction->posted)
                <a href="{{ route('coi_r.edit', Crypt::encrypt($transaction->id)) }}" class="btn btn-sm btn-neutral loading">Edit</a>
...
<div class="card">
    ...
    <div class="card-header border-0">
        ...
        <div class="text-right">
            @if(!$transaction->posted)
                <a href="{{ route('coi_r.post', Crypt::encrypt($transaction->id)) }}" class="btn btn-success" onclick="return confirm('Are you sure you want to Post this transaction?')">Post</a>
            @else
                <a href="{{ route('coi_r.print', Crypt::encrypt($transaction->id)) }}" class="btn btn-success">Print</a>
            @endif
        </div>
    </div>
</div>
