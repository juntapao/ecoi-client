...
<div class="container">
    <table class="tb1">
        ...
        <tr class="font10">
            ...
            <td width = "10%">:</td>
            <td width = "50%">DT<strong>{{ $transaction->coi_number }}</strong></td>
        </tr>
        <tr class="font10">
            <td width = "5%"></td>
        ...
        <tr class="font10 bord">
            ...
            <td width = "40%" align="left">Accidental Death/ Permanent Disablement <i>(excluding death due to motorcycle)</i></td>
