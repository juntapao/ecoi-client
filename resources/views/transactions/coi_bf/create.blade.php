...
<div class="card">
    ...
    <div class="card-header border-0">
        <form method="post" action="{{ route('coi_bf.store') }}" novalidate>
            @csrf
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="dateofbirth">Date of Birth <small>(17-75 years old)</small></label>
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" id="address" name="address" class="form-control text-uppercase @error('address') is-invalid @enderror" placeholder="Address" value="{{ old('address') }}" />
