...
<div class="container">
    <table class="tb1" style="font-size:8px;">
        ...
        <tr class="font10">
            ...
            <td width = "10%">:</td>
            <td width = "50%">BF<strong>{{$transaction->coi_number}}</strong></td>
        </tr>
        <tr class="font10">
            <td width = "5%"></td>
        ...
        <tr class="font10">
            ...
            <td width = "10%">:</td>
            <td width = "50%"><strong>ML PINOY PROTECT FIVE</strong></td>
        </tr>
        <tr class="font10">
            <td width = "5%"></td>
        ...
        <tr class="font10 bord">
            ...
            <td width = "40%" align="left">Accidental Death/ Permanent Disablement<br/><i>(except accidental death due to motorcycle)</i></td>
        ...
        <tr class="font10 bord">
            <td width = "5%" style="border:none;"></td>
            <td width = "40%" align="left">Motorcycling (due to accidental death)</td>
