...
@section('delete', route('coi_bf.destroy', Crypt::encrypt($transaction->id)))
@section('header')
    <div class="row align-items-center py-4">
        <div class="col-7 col-lg-6">
            ...
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                ...
                <li class="breadcrumb-item"><a href="{{ route('coi_bf.index') }}">Pinoy Protect Five</a></li>
        ...
        <div class="col-5 col-lg-6 text-right">
            ...
            @if(!$transaction->posted)
                <a href="{{ route('coi_bf.edit', Crypt::encrypt($transaction->id)) }}" class="btn btn-sm btn-neutral loading">Edit</a>
...
<div class="card">
    ...
    <div class="card-header border-0">
        ...
        <div class="text-right">
            @if(!$transaction->posted)
                <a href="{{ route('coi_bf.post', Crypt::encrypt($transaction->id)) }}" class="btn btn-success" onclick="return confirm('Are you sure you want to Post this transaction?')">Post</a>
            @else
                <a href="{{ route('coi_bf.print', Crypt::encrypt($transaction->id)) }}" class="btn btn-success">Print</a>
            @endif
        </div>
    </div>
</div>
