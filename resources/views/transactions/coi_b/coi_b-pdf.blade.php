...
<div class="container">
    <table class="tb1" style="font-size:8px;">
        ...
        <tr class="font10">
            ...
            <td width = "10%">:</td>
            <td width = "50%">B<strong>{{ $transaction->terminal_coi_number }}</strong></td>
        </tr>
        <tr class="font10">
            <td width = "5%"></td>
        ...
        <tr class="font10">
            ...
            <td width = "10%">:</td>
            <td width = "50%"><strong>ML PINOY PROTECT - PLUS</strong></td>
        </tr>
        <tr class="font10">
            <td width = "5%"></td>
        ...
        <tr class="font10 bord">
            ...
            <td width = "17%">PHP {{$holder['cash_principal']}}</td>
        </tr>
        <tr class="font10 bord">
            <td width = "5%" style="border:none;"></td>
