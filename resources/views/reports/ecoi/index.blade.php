...
<div class="card">
    ...
    <div class="card-header border-0">
        <form method="post" action="{{ route('summary.store') }}" novalidate>
            @csrf
            <div class="container">
                <div class="row">
