...
{{-- @section('delete', route('posted.destroy', $transaction->id)) --}}
@section('header')
    <div class="row align-items-center py-4">
        <div class="col-7 col-lg-6">
            ...
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                ...
                <li class="breadcrumb-item"><a href="{{ route('posted.index') }}">Posted Transactions</a></li>
        ...
        <div class="col-5 col-lg-6 text-right">
            ...
            {{-- <a href="{{ route('posted.edit', $transaction->id) }}" class="btn btn-sm btn-neutral loading">Edit</a> --}}
